...
| --------------------------- | ------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `Shared`                    | Linux: TypeScript, lint, format, all Jest, migrations, Expo Doctor, npm audit                                                         | `npm run typecheck && npm run lint && npm run format:check && npm test && npm run test:persistence-migrations && npx expo-doctor && npm audit --audit-level=high`                                                                                                                                                                                                                                                                                                                                                           |
